...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'BFb89FjX1m5D26ed'); // Random key for encryption
...
$PROJECT_ID = "{A2869813-CA91-454B-B6BC-8B8D9C8D5DFE}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "growmorea", "qs" => "`", "qe" => "`");
